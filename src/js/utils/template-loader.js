...
export async function loadTemplate(modeName) {
    ...
    } else if (modeName === 'tetris' || modeName === 'snake' || modeName === 'mario' || modeName === 'flap' || modeName === 'neon_vector' || modeName.startsWith('game_')) {
    ...
    try {
        ...
        if (modeName === 'tetris' || modeName === 'snake' || modeName === 'mario' || modeName === 'flap' || modeName === 'neon_vector' || modeName.startsWith('game_')) {
